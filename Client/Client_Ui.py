...
"")
        ...
        font.setFamily("3ds")
        font.setPointSize(10)
        self.Btn_Preset = QtWidgets.QPushButton(Client)
        self.Btn_Preset.setGeometry(QtCore.QRect(680, 575, 75, 30))
        font = QtGui.QFont()
        font.setFamily("3ds")
        font.setPointSize(10)
        self.Btn_Preset.setFont(font)
...
"")
    ...
    def retranslateUi(self, Client):
        ...
        self.Btn_Preset.setText(_translate("Client", "Presets"))
