...
from Preset_Ui_Class import application
...
class mywindow(QMainWindow,Ui_Client):
    def __init__(self):
        ...
        self.Btn_Preset.clicked.connect(self.openPresets)
    ...
    def openPresets(self):
        print('Open Presets')
        '''
        self.presetwindow = QtWidgets.QMainWindow()
        self.presetui = Ui_MainWindow
        self.presetui.setupUi(self,self.presetwindow)
        self.presetwindow.show()
        '''
        print(self.TCP)
        self.presetWindow = application(self.TCP)
        self.presetWindow.show()
